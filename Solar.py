...
NREL_API_KEY = "3aLhlrV6yesyZ1dwcoeqVIx5ccIFp9tJoDcXnOcB"
NREL_API_EMAIL = "rylan.moore@colorado.edu"
# replace with key and email address from https://developer.nrel.gov/signup/
sam_api_key = os.environ.get('NREL_API_KEY') or NREL_API_KEY
sam_email = os.environ.get('NREL_API_EMAIL') or NREL_API_EMAIL
...
if geocode:
    ...
    g = geocoder.bing('san diego, ca', key=geocode_api_key)
    lon = g.latlng[1]
    lat = g.latlng[0]
else:
    lon = -117.16
